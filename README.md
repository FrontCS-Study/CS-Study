...
| 9회차  | 230808 |       프로그래밍, 자바스크립트란, 변수        | 정현, 연수, 아현 |           |
| 10회차 | 230811 |      데이터 타입, 타입 변환과 단축 평가       | 정현, 연수, 아현 |           |
| 11회차 | 230815 |    배열, 객체 리터럴, 원시 값과 객체 비교     | 정현, 연수, 아현 |           |
| 12회차 | 230818 |      함수, 생성자함수, 함수와 일급 객체       | 정현, 연수, 아현 |           |
| 13회차 | 230822 |    스코프, this, strick mode, 실행컨텍스트    | 정현, 연수, 아현 |           |
| 14회차 | 230825 | 프로토타입, 빌트인객체, 클래스, 스프레드문법  | 정현, 연수, 아현 |           |
